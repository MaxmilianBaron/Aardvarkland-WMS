...
import { ConfigureWmsAppOptions, configureWmsApp } from './bootstrap/configure-wms-app';

export { ConfigureWmsAppOptions, configureWmsApp, setupSwagger } from './bootstrap/configure-wms-app';
