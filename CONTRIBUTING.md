...
Keep pull requests focused. Do not include generated output, credentials, customer data, local databases, production URLs, signing files, real warehouse exports, personal information, internal automation tooling or metadata, user-specific absolute paths, or captures from personal devices. Use fictional examples in tests and documentation.
